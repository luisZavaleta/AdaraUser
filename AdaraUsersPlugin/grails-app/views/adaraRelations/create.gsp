                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: adaraRelationsInstance, field: 'idRole', 'errors')}">
                                   <g:select name="idRole" from="${roleList}" optionKey="id" optionValue="name" noSelection="['null': 'Selecciona...']" /> 
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <g:select name="id3DObject" from="${objects3DList}" optionKey="id" optionValue="baseFileName" noSelection="['null': 'Selecciona...']" /> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: adaraRelationsInstance, field: 'idMarker', 'errors')}">
                                 ...
                                 <g:select name="idMarker" from="${markerList}" optionKey="id" optionValue="name" noSelection="['null': 'Selecciona...']" /> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: adaraRelationsInstance, field: 'idMenu', 'errors')}">
                                     <g:select name="idMenu" from="${menuList}" optionKey="id" optionValue="texto" noSelection="['null': 'Selecciona...']" /> 
